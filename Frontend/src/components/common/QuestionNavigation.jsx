...
const getStatus = (index, answeredQuestions, currentQuestion, lockedQuestions) => {
  if (index === currentQuestion) return "current";
  if (lockedQuestions?.[index]) return "locked";
  ...
  <div style={{ background: "rgba(255,255,255,0.9)", borderRadius: 24, padding: 24, margin: '24px auto', maxWidth: 700 }}>
    <div style={{ display: "flex", flexWrap: "wrap", gap: 16, justifyContent: "center" }}>
      {Array.from({ length: totalQuestions }, (_, i) => {
        const idx = i;
        const status = getStatus(idx, answeredQuestions, currentQuestion, lockedQuestions);
    ...
    <div style={{ marginTop: 16, textAlign: "center", fontSize: 14 }}>
      ...
      <span style={{ color: statusColors.locked, background: borderColors.locked, borderRadius: '50%', padding: '0 6px' }}>●</span> Locked&nbsp;|&nbsp;
