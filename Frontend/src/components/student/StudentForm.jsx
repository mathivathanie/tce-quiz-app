    ...
    <div style={gradientStyles.container}>
      <div style={gradientStyles.cardCyan}>
        ...
        <div style={{ ...gradientStyles.centerContent, marginBottom: '30px' }}>
          ...
          <p style={gradientStyles.subtitle}>
            Questions: {currentQuiz?.questions?.length || 0} | Time:{' '}
            {Math.round(
              (currentQuiz?.timerType === 'hybrid'
                ? (currentQuiz?.questions?.length || 0) * (currentQuiz?.maxTimePerQuestion || 300)
                : (currentQuiz?.totalTimeSeconds || 3600)) / 60
            )}{' '}
            minutes
          </p>
        </div>
        ...
        >
          ...
          <option value="TSEDA">Architecture</option>
